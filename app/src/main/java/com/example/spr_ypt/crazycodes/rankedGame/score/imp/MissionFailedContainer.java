...
public class MissionFailedContainer extends AbsScoreContainer {
    ...
    public MissionFailedContainer(ScoreViewHolder holder) {
        super(holder);
    }

    @Override
    public void onDataChanged() {
        mViewHolder.mTvTaskFailed.setText("\uD83D\uDE02 任务失败");
        resetScoreInfo();
    }
    ...
    public int getContainerType() {
        return ScoreContainerType.STATE_MISSION_FAILED;
    }
    ...
    public List<View> getShowViews() {
        ...
        views.addAll(mViewHolder.missionFailedViews);
