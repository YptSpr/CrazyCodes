...
public class PkProgressDrawableV3 extends Drawable {
    ...
    private int mDurationForRate = 500;
    private int mDurationForColor = 5000;
    ...
    public PkProgressDrawableV3(@FloatRange(from = 0.0f, to = 1.0f) float rate) {
        this.rate = rate;
        this.progress = rate;
        this.mlastRate = rate;
        init();
    ...
    public PkProgressDrawableV3(Paint leftPaint, Paint rightPaint) {
        this.leftPaint = leftPaint;
        this.rightPaint = rightPaint;
        init();
    }

    public PkProgressDrawableV3(float rate, Paint leftPaint, Paint rightPaint) {
        this.rate = rate;
        this.progress = rate;
        this.mlastRate = rate;
        this.leftPaint = leftPaint;
    ...
    private void initAnims() {
        ...
        mAnimForRate.setDuration(mDurationForRate);
...
//                invalidateSelf();
        ...
        mAnimForColor.setDuration(mDurationForColor);
    ...
    public void setmDurationForRate(int mDurationForRate) {
        this.mDurationForRate = mDurationForRate;
        mAnimForRate.setDuration(mDurationForRate);
    }
